...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <a class="navbar-brand" href="#"><i class="fas fa-tachometer-alt"></i> Client Dashboard</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0)" onclick="loadPage('../Client/afficher_reservation_client.php?CIN=' . $_GET['CIN'], this)"><i class="fas fa-users"></i> Afficher Réservations</a>
                </li>  
                <li class="nav-item">
                    <a class="nav-link" href="javascript:void(0)" onclick="loadPage('../Reservation/ajouter_reservation.php', this)"><i class="fas fa-calendar-alt"></i> Ajouter Réservations</a>
                </li>
            </ul>
    ...
    <div class="iframe-container">
        <iframe id="content-frame" src="../Reservation/afficher_reservation_client.php?CIN=<?php echo $_GET['CIN']; ?>"></iframe>
